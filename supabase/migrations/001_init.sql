...
create index if not exists runs_territory_idx on public.runs using gist(territory);
create index if not exists user_territory_idx on public.user_territory using gist(merged_territory);
